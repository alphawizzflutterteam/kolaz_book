  ...
  Widget build(BuildContext context) {
    return
        ...
        GetBuilder(
            init: HomeController(),
            builder: (controller) {
              countryName = controller.profiledata!.country.toString();
              ...
              return Scaffold(
                  ...
                  //   ],
                  // ),
                  body: controller.profiledata!.country != null
                      ? SafeArea(
                          child: Column(
                                                              ...
                                                              ? Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      ...
                                                                      image: DecorationImage(
                                                                          image: NetworkImage(getPortfolioData[index]
                                                                              .coverImage
                                                                              .toString()),
                                                                          fit: BoxFit
                                                                              .fill)),
                                                              ...
                                                              children: [
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      getPortfolioData[index].companyName == null ||
                                                          ...
                                                          child: getPortfolioData[index]
                                                            ...
                                                            BoxDecoration(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  ...
                                                                  image: DecorationImage(
                                                                      image:
                                                                      NetworkImage(getPortfolioData[index].profilePic.toString())))),
                                                        )
                                                      )
                                                    ],
                                                  ),
                      ...
                      : SafeArea(
                          ...
                          children: [
                            ...
                            Container(
                                ...
                                child: Center(
                                    child: Text(
                                  "Please select Country first to access this feature",
                                  style: TextStyle(
                                      color: AppColors.whit, fontSize: 15),
                                )))
                          ],
                        )));
              // }
              ...
              //       Container(
              //         height: MediaQuery.of(context).size.width,
              //           child: Center(child: Text("Please select Country first to access this feature", style: TextStyle(color: AppColors.whit, fontSize: 15),)))
              //     ],
              //   )
              // );
            });
