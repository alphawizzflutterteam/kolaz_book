...
class _PortfolioScreenState extends State<PortfolioScreen> {
  ...
  getPortfolios() async {
    ...
    request.fields['category'] = typeController != null ?  typeController.toString(): '';
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                      onTap: () {
                                        if(myPortfolioData.isNotEmpty) {
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                  builder: (context) =>
                                                      AddPortfolioScreen(
                                                          data: myPortfolioData[0])));
                                        }else{
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      const Padding(
                        padding:
                            EdgeInsets.only(top: 10, left: 2.0, bottom: 5),
                        child: Text(
                          "Filter by State",
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: CustomSearchableDropDown(
                            ...
                            dropdownBackgroundColor: AppColors.teamcard2,
           ...
           const Padding(
              padding: EdgeInsets.only(top: 15.0, bottom: 5, left: 12),
              child: Text(
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: CustomSearchableDropDown(
                        ...
                        backgroundColor: AppColors.teamcard2,
                        dropdownBackgroundColor: AppColors.teamcard2,
                        dropdownItemStyle: const TextStyle(color: AppColors.whit),
                        // dropdownHintText: TextStyle(
                        //   color: AppColors.whit
                        // ),
                        items: typeofPhotographyEvent,
                        label: 'Type of Photography',
                        labelStyle: const TextStyle(color: AppColors.whit),
                        ...
                        multiSelect: false,
                        dropDownMenuItems: typeofPhotographyEvent.map((item) {
                              return "${item.resName}";
                            }).toList() ??
                            [],
                        onChanged: (value) {
                          ...
                          print("this is my country code ${typeController}");
                        },
                      ),
                    ),
                  ),
            ...
            Expanded(
              child: ListView.builder(
                ...
                return InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> MyPortfolioScreen(
                      data: getPortfolioData[index]
                    )));
                  },
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                         Column(
                           children: [
                      getPortfolioData[index].coverImage != null || getPortfolioData[index].coverImage.toString() != '' ?
                      Container(
                               height: 120,
                               decoration: BoxDecoration(
                                 color: AppColors.whit,
                                 ...
                                 DecorationImage(
                                   image:
                                   NetworkImage(
                                     getPortfolioData[index].coverImage.toString()
                                   ),
                                   fit: BoxFit.fill
                                 )
                               ),
                               ...
                               child: Row(
                                 ...
                                 children: [
                                   Column(
                                     ...
                                     crossAxisAlignment: CrossAxisAlignment.start,
                                     children: [
                                       Text('${getPortfolioData[index].fname.toString()} ${getPortfolioData[index].lname.toString()}',
                                         style: const TextStyle(
                                       ...
                                       Text(
                                           getPortfolioData[index].companyName == null || getPortfolioData[index].companyName == '' ?
                                               ""
                                         : getPortfolioData[index].companyName.toString() ?? "",
                                         style: const TextStyle(
                                             color: Colors.white,
                                             fontWeight: FontWeight.w400,
                                             fontSize: 13),
                                   ...
                                   Padding(
                                     ...
                                     child: Text(
                                         getPortfolioData[index].categoryId.toString(),
                                       style: const TextStyle(
                                           color: Colors.white,
                                           fontWeight: FontWeight.w400,
                                           fontSize: 14),
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              decoration:  BoxDecoration(
                                ...
                                image: DecorationImage(image: NetworkImage( getPortfolioData[index].profilePic.toString()))
                              ),
                            ),
                          )
