...
class EditClientJob extends StatefulWidget {
  ...
  final  data;
  const EditClientJob({Key? key, this.allJobs, this.type, this.upcomingJobs, this.data}) : super(key: key);
...
class _EditClientJobState extends State<EditClientJob> {
  ...
  List <PhotographerData> photographerList =[];
  ...
  deleteConfirmation(BuildContext context) {
    return AlertDialog(
      ...
      content: const Text(
        'Are you sure you want to delete this client job?',
        style: TextStyle(color: AppColors.textclr),
      ),
      actions: [
        TextButton(
                              ...
                              child: DropdownButton(
                                ...
                                onChanged: (newValue) {
                                  print("my selected val $newValue");
                                    ...
                                    pType[index] = {'photographer_type': newValue.toString()};
                                        newValue;
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              ...
                              // Initial Value
                              value:
                              pType[index] == null ?pType[index] : pType[index]['photographer_id'] ,
                              isExpanded: true,
                              hint: const Text(
                                "Photographer",
                                style: TextStyle(
                              ...
                              // Array list of items
                              items: photographerList.map((items) {
                                return DropdownMenuItem(
                              ...
                              onChanged: (newValue) {
                                ...
                                pType[index]['photographer_id'] = newValue;
                                setState(() {
  ...
  void initState() {
    super.initState();
    // print("thisis my dtat and ${widget.data['photographers_details']}");
    getPhotographerType();
    getEventTypes();
    getCitiesList();
    getClients();
    getPhotographerList();
    setState(() {
      newList = widget.data['photographers_details']!;
    });
    print("this i s my new list $newList");
    for(var i = 0; i< newList.length; i ++){
      up.add(newList[i]['date']);
