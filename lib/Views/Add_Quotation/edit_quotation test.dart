...
class EditQuotationNew extends StatefulWidget {
  final String? qid, id;
  const EditQuotationNew({Key? key, this.qid, this.id}) : super(key: key);

  @override
  State<EditQuotationNew> createState() => _EditQuotationNewState();
}

class _EditQuotationNewState extends State<EditQuotationNew> {
