/// response_code : "1"
/// msg : "Get Date"
/// data : [{"id":"133","first_name":"vivek","last_name":"Singh","city":"indore","mobile":"2147483647","photographer_type":null,"compny_name":null,"per_day_charges":null,"type":"client","status":"1","created_at":"2023-05-31 11:50:51","user_id":"158"},{"id":"136","first_name":"Vikram","last_name":"Singh","city":"Dhanbad","mobile":"2147483647","photographer_type":null,"compny_name":null,"per_day_charges":null,"type":"client","status":"1","created_at":"2023-05-31 12:58:14","user_id":"158"},{"id":"137","first_name":"Parth","last_name":"Verma","city":"Ujjain","mobile":"2147483647","photographer_type":null,"compny_name":null,"per_day_charges":null,"type":"client","status":"1","created_at":"2023-05-31 12:58:32","user_id":"158"},{"id":"138","first_name":"Ayush","last_name":"Chavhan","city":"Manali","mobile":"2147483647","photographer_type":null,"compny_name":null,"per_day_charges":null,"type":"client","status":"1","created_at":"2023-05-31 12:59:07","user_id":"158"},{"id":"140","first_name":"Suraj","last_name":"pandey","city":"Indian","mobile":"2147483647","photographer_type":null,"compny_name":null,"per_day_charges":null,"type":"client","status":"1","created_at":"2023-05-31 14:01:15","user_id":"158"},{"id":"146","first_name":"Suraj","last_name":"pandey","city":"Indore","mobile":"2147483647","photographer_type":null,"compny_name":null,"per_day_charges":null,"type":"client","status":"1","created_at":"2023-06-01 10:53:19","user_id":"158"}]
import 'dart:convert';

PhotographerClientModel photographerClientModelFromJson(String str) => PhotographerClientModel.fromJson(json.decode(str));

String photographerClientModelToJson(PhotographerClientModel data) => json.encode(data.toJson());

class PhotographerClientModel {
  PhotographerClientModel({
      String? responseCode, 
      String? msg, 
      List<PhotogrpaherClientData>? data,}){
    _responseCode = responseCode;
    _msg = msg;
    _data = data;
}

  PhotographerClientModel.fromJson(dynamic json) {
    _responseCode = json['response_code'];
    _msg = json['msg'];
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
        _data?.add(PhotogrpaherClientData.fromJson(v));
      });
    }
  }
  String? _responseCode;
  String? _msg;
  List<PhotogrpaherClientData>? _data;
PhotographerClientModel copyWith({  String? responseCode,
  String? msg,
  List<PhotogrpaherClientData>? data,
}) => PhotographerClientModel(  responseCode: responseCode ?? _responseCode,
  msg: msg ?? _msg,
  data: data ?? _data,
);
  String? get responseCode => _responseCode;
  String? get msg => _msg;
  List<PhotogrpaherClientData>? get data => _data;
...
class PhotogrpaherClientData {
  PhotogrpaherClientData({
      String? id, 
      String? firstName, 
      String? lastName, 
      String? city, 
  ...
  PhotogrpaherClientData.fromJson(dynamic json) {
    _id = json['id'];
  ...
  String? _createdAt;
  String? _userId;
PhotogrpaherClientData copyWith({  String? id,
  String? firstName,
  String? lastName,
  String? city,
  String? mobile,
  ...
  String? createdAt,
  String? userId,
}) => PhotogrpaherClientData(  id: id ?? _id,
